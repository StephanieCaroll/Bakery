...
    // Se o nome do domínio antes do .com tiver menos de 3 letras (ex: a.com)
...
      return showAlert("E-mail Inválido", "Por favor, use um e-mail real e válido.", "error");
    }
...
    if (isRegister) {
      if (formData.phone.length < 10) {
        return showAlert("WhatsApp", "Digite o número com DDD.", "error");
      }
